...
public class CalendarioTest {
    ...
    public void creacionDeCalendarioVacio() {
        ...
        calendario.modificarActividadAgregarAlarma(123, Plazo.DIAANTES);
        assertNull(calendario.proximaAlarma());
        assertEquals(0, calendario.sonarAlarmas().size());
    ...
    public void creacionesDeAlarmasCalendario() {
        ...
        calendarioDePrueba.modificarActividadEliminarAlarma(indice, Plazo.DIAANTES);
        ...
        calendarioDePrueba.modificarActividadAgregarAlarma(indice, Plazo.HORAANTES);
